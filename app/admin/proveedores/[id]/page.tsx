...
import { obtenerPerfilArtesano, eliminarArtesano } from "@/lib/services/artesanoService"
import {
  ArrowLeft,
  MapPin,
  Phone,
              ...
              <Card className="border-0 shadow-sm rounded-4xl bg-[#F8F7F4] relative overflow-hidden">
                ...
                <CardContent className="p-8 md:p-10 relative z-10">
                  ...
                  <div className="prose prose-gray max-w-none">
                    ...
                    {/* Si tuvieras más texto de biografía, podrías ponerlo aquí sin itálicas. Como solemos tener un solo campo, mostramos todo en la cita principal. */}
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="border-0 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] rounded-4xl bg-white">
                  <CardContent className="p-6 md:p-8 flex flex-col justify-center min-h-35">
                    ...
                    <span className="text-lg font-mono tracking-tight text-gray-900">
                      {artesano.telefono ? (
                        // Formatear el teléfono si es de 10 dígitos (ej. +52 951 402 8831)
